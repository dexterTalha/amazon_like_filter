                  ...
                  children: [
                    ...
                    Visibility(
                      ...
                      child: IconButton(
                        ...
                        icon: _filterCubit.filterProps.closeIcon ?? const Icon(Icons.close),
                      ),
                    )
                  ],
                ),
                                ...
                                return GestureDetector(
                                  ...
                                  child: Padding(
                                    ...
                                    child: FilterText(
                                      title: e.title,
                                      fontSize: 17,
                                      style: (index == state.activeFilterIndex) ? themeProps?.activeFilterTextStyle : themeProps?.inActiveFilterTextStyle,
                                      fontWeight: FontWeight.w500,
                                      fontColor: (index == state.activeFilterIndex)
                                          ? themeProps?.activeFilterTextColor ?? getTheme(context).primaryColor
                                    ...
                                    builder: (context, searchValue, child) {
                                      return TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                            hintText: themeProps?.searchBarViewProps?.searchHint ?? 'Search',
                                            /*contentPadding:
                                            ...
                                            fillColor: themeProps?.searchBarViewProps?.fillColor?.withOpacity(0.8) ?? Theme.of(context).primaryColor.withOpacity(0.1),
                                            filled: themeProps?.searchBarViewProps?.filled ?? true,
                                            border: themeProps?.searchBarViewProps?.inputBorder ??
                                                OutlineInputBorder(
                                                  borderRadius: BorderRadius.circular(10),
                                                  borderSide: BorderSide(
                                                    width: 1,
                                                    color: themeProps?.searchBarViewProps?.fillColor ?? getTheme(context).primaryColor,
                                                  ),
                                                ),
                                            suffixIcon: searchValue.isNotEmpty
                                                ? IconButton(
                                                    ...
                                                    icon: themeProps?.searchBarViewProps?.clearIcon ?? Icon(Icons.close, color: themeProps?.searchBarViewProps?.clearIconColor),
                                                  )
                                                : IconButton(
                                                    onPressed: () {
                                                      _filterCubit.filterBySearch(_searchController.text);
                                                    },
                                                    icon: themeProps?.searchBarViewProps?.searchIcon ??
                                                        Icon(
                                                          Icons.search,
                                                          color: themeProps?.searchBarViewProps?.searchIconColor,
                                                        ),
                                                  )),
                                    ...
                                    return ListView.builder(
                                      ...
                                      itemBuilder: (_, index) {
                                        ...
                                        return FilterCheckboxTitle(
                                          checkBoxTileThemeProps: themeProps?.checkBoxTileThemeProps,
